...
export const DynamicFieldSet = (props) => {
  return (
    <Form
        ...
        {(fields, { add, remove }, { errors }) => (
          <>
            <div className="text-center ">
              <TextInput
                placeholder={props.selectInputText}
            ...
            <Form.Item className="mt-5">
              ...
              >
                ...
                >
                  <PlusOutlined />
                  <p className="pl-1 ">Add Test Types</p>
                </div>
              </Button>
